"""
Mix-in functionality for Chaco interactive colormaps
...
from traits.api import HasTraits, Property, Trait, Bool, Int
from traits.ui.api import Group, Item
import numpy as N
cm._cmapnames.sort()
...
class ColormapControl(HasTraits):
    ...
    from traits.ui.api import Include
    ...
